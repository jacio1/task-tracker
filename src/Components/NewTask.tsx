...
function NewTask() {
  return (
    <div className="w-[418px] h-[696px] rounded-xl p-8 bg-white">
      ...
      <form className="">
        <h2 className="font-medium text-lg text-[#000b30] pt-8">Название задачи</h2>
        <input
          type="text"
        ...
        />
        <h2 className="font-medium text-lg text-[#000b30] pt-6">Описание задачи</h2>
        <input
          type="text"
        ...
        />
        <h2 className="font-medium text-lg text-[#000b30] pt-6">Срок исполнения</h2>
        <input
          type="date"
